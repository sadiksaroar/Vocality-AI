...
//   final List<Map<String, String>> timePackages = [
//     {'duration': '12 min', 'price': '\$4.99'},
//     {'duration': '24 min', 'price': '\$8.99'},
//     {'duration': '36 min', 'price': '\$12.99'},
//     {'duration': '48 min', 'price': '\$16.99'},
//     {'duration': '60 min', 'price': '\$19.99'},
//     {'duration': '120 min', 'price': '\$34.99'},
//   ];
...
//           //   ),
//           // ),
//           // Replace the Expanded widget with a Container with fixed aspect ratio
//           Container(
//             width: double.infinity,
//             // aspectRatio: 1, // Makes it square - adjust this value (e.g., 1.2 for slightly taller)
//             child: Stack(
//               children: [
//                 // Image layer (bottom)
//                 Container(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              icon: const Icon(Icons.lock, size: 11),
              label: Text(
                personality['unlocked'] ? 'Active' : 'Unlock',
                style: const TextStyle(
                  fontWeight: FontWeight.w600,
